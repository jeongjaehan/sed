...
public class SimpleHTTPClient implements ResponseHandler<byte[]> 
{
	...
	private void logExecResult(byte[] resultBytes)
	{
		...
		for(int i=0;i<paramCount;i++)
		{
			...
			paramBuffer2.append(nvp.getName()).append("=").append(nvp.getValue()).append("&");
		}
		
		String paramString = StringUtils.removeEnd(paramBuffer.toString(), ",");
		String paramString2 = StringUtils.removeEnd(paramBuffer2.toString(), "&");
		...
		logBuffer2.append("SimpleHTTPClient [").append(method).append("][").append(url).append("?").append(paramString2).append("]");
